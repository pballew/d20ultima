...
public partial class Player : Character
{
    ...
    [Signal]
    public delegate void TownNameDisplayEventHandler(string town_name);
    ...
    public void check_for_random_encounter(Vector2 worldPos, Node terrainSystem)
    {
        ...
        {
            EmitSignal("EncounterStartedEventHandler");
        }
    }
    ...
    public void check_for_town_at_position(Vector2 worldPos)
    {
        ...
        if (terrain != null && terrain.HasMethod("get_town_data_at_position"))
        {
            ...
            if (townData != null && townData is Godot.Collections.Dictionary dict && dict.Count > 0)
            {
                ...
                EmitSignal("TownNameDisplayEventHandler", townName);
    ...
    public float get_encounter_difficulty_multiplier_for_terrain(int terrainType) => GetEncounterDifficultyForTerrain(terrainType);
}
